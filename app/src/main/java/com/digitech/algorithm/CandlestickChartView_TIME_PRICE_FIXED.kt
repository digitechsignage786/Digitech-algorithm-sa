...
class CandlestickChartView(context: Context) : View(context) {
    ...
    private fun chartBottom(): Float {
        // Reserve a little extra room for the two-line time/price axis.
        return height - 72f
    }
    ...
    private fun drawTimeScale(
        ...
        for (
            ...
            // TradingView-style two-line axis: time first, price directly below it.
            val timeLabel =
                sdf.format(
                    java.util.Date(
                        candles[i].time
