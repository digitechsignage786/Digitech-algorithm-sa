    ...
    private val scaleDetector = ScaleGestureDetector(
        ...
        object : ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            override fun onScale(
                ...
                // Smooth the physical pinch slightly. Pinch zoom controls the
                // TIME/candle scale only. Vertical PRICE zoom remains dedicated
                // to the price-scale gesture, preventing the chart from flying
                // to the top/bottom as seen in the previous build.
