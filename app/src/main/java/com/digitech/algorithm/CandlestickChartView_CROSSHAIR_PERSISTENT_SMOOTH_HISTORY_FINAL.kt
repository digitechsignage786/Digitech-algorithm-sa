                    ...
                    if (!crosshairVisible) {
                        ...
                        when {
                            ...
                            nearHorizontal -> {
                                ...
                                // When the crosshair is already visible, touching
                                // anywhere else on the chart starts a normal
                                // two-axis crosshair drag. Do NOT remove it on
                                // ACTION_DOWN. A clean tap (no movement) is handled
                                // on ACTION_UP and is the only way to dismiss it.
                                crosshairDragMode = CrosshairDragMode.BOTH
                                dragging = true
                            }
                        }
