    ...
    private val liveClockRunnable = object : Runnable {
        override fun run() {
            ...
            if (tickTime > 0L && price.isFinite()) {
                ...
                // Keep the current candle visually alive between real ticks.
                // The price itself is NOT changed or simulated: this simply
                // re-renders the candle using the latest real market price.
                chart.invalidate()
            }
