...
class CandlestickChartView(context: Context) : View(context) {
    ...
    private fun saveDrawings() {
        try {
            ...
            root.put("measure", lineArray(measurements))
    ...
    private fun loadDrawings() {
        ...
        try {
            ...
            readLines("channel", parallelChannels); readLines("fib", fibonacciLines); readLines("measure", measurements)
