...
class CandlestickChartView(context: Context) : View(context) {
    ...
    // Compatibility APIs used by MainActivity. These only update the existing
    // live-state values; they do not change chart layout, price/countdown placement,
    // drawing anchoring, pan, or zoom behavior.
