    ...
    private val scaleDetector = ScaleGestureDetector(
        ...
        object : ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            override fun onScale(
                ...
                // Keep the original pinch center fixed for the whole gesture.
                // ScaleGestureDetector's focus can move slightly as fingers move,
                // which otherwise makes the chart drift from side to side.
                val focusX = scaleAnchorX
                ...
                offsetX =
                    focusX -
                    chartLeft -
                    (focusX - chartLeft - offsetX) * zoomRatio

                zoom = newZoom

                // Never let the complete candle series run outside both sides
                // of the chart during a pinch. This prevents the visual jump
                // where candles appear to fly away in opposite directions.
