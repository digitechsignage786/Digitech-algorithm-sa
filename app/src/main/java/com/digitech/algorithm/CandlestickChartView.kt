            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (activeTool != DrawingTool.CROSSHAIR) {
                    ...
                    if (
                        ...
                        // One-finger chart navigation: move the whole chart
                        // freely in both directions. Horizontal movement pans
                        // through time; vertical movement pans the price field.
                        // Drawings move with the chart so they stay attached.
                        offsetX += dx
                        pricePan += screenDyToPricePan(dy)
                        translateDrawings(dx, dy)
