    ...
    private val scaleDetector = ScaleGestureDetector(
        ...
        object : ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            override fun onScale(
                ...
                // Keep the candle under the pinch focus anchored.
                // The chart has a left inset, so it must be included in
                // the coordinate conversion; otherwise the whole chart
                // jumps left/right during zoom.
