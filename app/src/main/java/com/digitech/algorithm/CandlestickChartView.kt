        ...
        object : ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            override fun onScale(
                ...
                if (newZoom != oldZoom) {
                    ...
                    scaleDrawings(newZoom / oldZoom, 1f, focusX, focusY)
                    zoom = newZoom
                }
    ...
    override fun onTouchEvent(
        ...
        when (event.actionMasked) {
            ...
            MotionEvent.ACTION_DOWN -> {
                ...
                // changes ONLY horizontal scale. The newest/right edge stays
                // anchored, so candles zoom toward/away from one side.
                timeScaleDragging = event.y >= chartBottom()
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (priceScaleDragging) {
                    ...
                    val factor = kotlin.math.exp((dy * 0.0105f).toDouble()).toFloat()
                    val oldPriceZoom = priceZoom
                ...
                if (timeScaleDragging) {
                    ...
                    val factor = kotlin.math.exp((-dx * 0.0105f).toDouble()).toFloat()
                    val oldZoom = zoom
