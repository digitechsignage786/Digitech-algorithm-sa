...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        ...
        infoBar.addView(
            changeText,
            LinearLayout.LayoutParams(dp(62), dp(22))
        )
        ...
        infoBar.addView(
            statusText,
            LinearLayout.LayoutParams(dp(58), dp(22))
        )
        ...
        toolbar.setPadding(0, dp(1), 0, dp(1))
        ...
        watchlist.setPadding(dp(1), dp(1), dp(1), dp(1))
        ...
        // Landscape: give almost all available height to the chart.
        if (resources.configuration.orientation == android.content.res.Configuration.ORIENTATION_LANDSCAPE) {
            topBar.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(34))
            timeframeScroll.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(26))
            infoBar.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(22))
            signalBox.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(22))
            bottomBar.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(26))
        }
    }
