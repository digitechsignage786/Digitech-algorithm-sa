    ...
    private val scaleDetector = ScaleGestureDetector(
        ...
        object : ScaleGestureDetector.SimpleOnScaleGestureListener() {
            ...
            override fun onScale(
                ...
                val left = chartLeft()
                val oldStep = candleStep()

                // Convert the current pinch focus to a logical candle position
                // before changing zoom. Then calculate the new offset so that
                // exactly that same candle position remains under the fingers.
                val focusX =
                ...
                // Clamp only after the anchored position has been calculated.
                // This prevents the repeated left/right jump caused by clamping
                // against the old zoom geometry on every detector update.
