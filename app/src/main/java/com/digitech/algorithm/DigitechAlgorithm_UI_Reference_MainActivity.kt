...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        ...
        tfScroll.addView(timeframeBar, android.widget.HorizontalScrollView.LayoutParams.WRAP_CONTENT, dp(38))
        ...
        infoBar.addView(priceText, LinearLayout.LayoutParams(0, MATCH_PARENT, 1f))
        ...
        infoBar.addView(changeText, LinearLayout.LayoutParams(dp(72), MATCH_PARENT))
        ...
        infoBar.addView(statusText, LinearLayout.LayoutParams(dp(76), MATCH_PARENT))
        ...
        mainArea.addView(toolbar, LinearLayout.LayoutParams(dp(38), MATCH_PARENT))

        chart = CandlestickChartView(this)
        mainArea.addView(chart, LinearLayout.LayoutParams(0, MATCH_PARENT, 1f))
        ...
        mainArea.addView(watchScroll, LinearLayout.LayoutParams(dp(82), MATCH_PARENT))
