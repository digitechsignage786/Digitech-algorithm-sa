...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        ...
        streamStatusText.text = "WS: --"
        streamStatusText.textSize = 9f
        streamStatusText.setTextColor(Color.GRAY)
        streamStatusText.gravity = Gravity.CENTER

        infoBar.addView(
            streamStatusText,
            LinearLayout.LayoutParams(82, LinearLayout.LayoutParams.MATCH_PARENT)
        )
    ...
    private fun loadMarketData() {
        ...
        if (apiKey.isBlank()) {
            ...
            streamStatusText.text = "WS: NO KEY"
                ...
                override fun onOpen(
                    ...
                    runOnUiThread {
                        if (serial == requestSerial) {
                            ...
                            streamStatusText.text = "WS: CONNECTED"
                ...
                override fun onFailure(
                    ...
                    runOnUiThread {
                        if (serial == requestSerial) {
                            ...
                            statusText.setTextColor(Color.YELLOW)
                            streamStatusText.text = "WS: ERROR"
                            streamStatusText.setTextColor(Color.RED)
                        }
                    }
                }
    ...
    private fun handleSubscribeStatus(
        ...
        try {
            ...
            runOnUiThread {
                ...
                when {
                    status.equals("ok", ignoreCase = true) ||
                        ...
                        streamStatusText.text = "WS: SUBSCRIBED"
                        streamStatusText.setTextColor(Color.rgb(30, 200, 140))
                    }

                    status.equals("warning", ignoreCase = true) -> {
                        streamStatusText.text = "WS: WARNING"
                        streamStatusText.setTextColor(Color.YELLOW)
                    }
            ...
            runOnUiThread {
                if (serial == requestSerial) {
                    streamStatusText.text = "WS: BAD MSG"
                    streamStatusText.setTextColor(Color.RED)
                }
            }
        }
